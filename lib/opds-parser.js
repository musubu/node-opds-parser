...
OpdsParser.prototype.getFeedType = function(json, callback) {
  var self = this
    , numberOfEntries = 0
    , acquisitionLinksCount = 0
    , entriesCount = 0;
  ...
  function isAcquisition(json, callback) {
    callback(
      json.links.some(function(l) {
        return l['@'].rel.indexOf('http://opds-spec.org/acquisition') >= 0;
      })
    )
  }
